...
app.get("/terms", (req, res) => {
  res.send(
    "<h1>Terms of Service (TTData)</h1><p>This is a temporary page for API verification.</p>"
  );
});

app.get("/privacy", (req, res) => {
  res.send(
    "<h1>Privacy Policy (TTData)</h1><p>This is a temporary page for API verification.</p>"
  );
});
